...
import { ensureRecurringSchedulesMaterialized } from "@/lib/recurring-schedule";
...
export default async function SchedulePage() {
  // Ленивая материализация: заполняет пропуски в обычном расписании из
  // активных регулярных настроек на ближайшие 14 дней. Делается тут, а
  // не в фоне — при каждом открытии страницы, надёжнее на Railway, чем
  // держать постоянный процесс.
  ensureRecurringSchedulesMaterialized();
  ...
  return (
    <div>
      ...
      <RecurringScheduleSection districts={districts} />
    </div>
  );
}
